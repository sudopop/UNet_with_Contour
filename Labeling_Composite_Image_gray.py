...
class Composite():
    ...
    def getitem(self, idx, bg_true=False):
        ...
        composite_img = cv2.add(fg_black, bg_white) #합성 이미지 결과 #RGB로 학습시 사
        ...
        composite_label_np = composite_label_np / 1 # 레이블링하게 255 -> 1로
...
def main():
    Anomaly_path = "./data/22/AnomalyImg/"
    # Anomaly_path= "../Img/TestImg/"
    True_path = "./data/22/TrueImg/"
    img_save_path = "./data/22/GreenOnion_Composite_img_gray/"
    label_save_path = "./data/22/GreenOnion_Composite_label_gray/"
